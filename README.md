...
| 主界面 | 历年分数查询 |
|:---:|:---:|
| ![主界面](docs/images/界面.png) | ![分数查询](docs/images/历年录取数据查询.png) |

| 专业知识问答 | 多模态输出（图片） |
|:---:|:---:|
| ![专业问答](docs/images/学校专业问题.png) | ![多模态](docs/images/输出多模态数据_图片.png) |

| 校园地图 | 移动端适配 |
|:---:|:---:|
| ![地图](docs/images/集成高德地图.png) | ![移动端](docs/images/适配移动端.png) |
